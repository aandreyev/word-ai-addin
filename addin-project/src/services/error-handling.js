...
class PerformanceMonitor {
   ...
   */
  cleanupOldMetrics(maxAge = 3600000) { // 1 hour default
...
export { Logger, ErrorHandler, PerformanceMonitor, LogLevel, globalLogger, globalErrorHandler, globalPerformanceMonitor };
